var GeoElementorDashboard=(()=>{var d=(v,e,a)=>new Promise((s,t)=>{var i=r=>{try{n(a.next(r))}catch(l){t(l)}},c=r=>{try{n(a.throw(r))}catch(l){t(l)}},n=r=>r.done?s(r.value):Promise.resolve(r.value).then(i,c);n((a=a.apply(v,e)).next())});var o=class{constructor(){this.data={overview:null,countries:[],rules:[],trends:[]},this.init()}init(){return d(this,null,function*(){this.renderLoading(),yield this.fetchData(),this.render()})}fetchData(){return d(this,null,function*(){try{let[e,a,s,t]=yield Promise.all([this.apiCall("/wp-json/geo-elementor/v1/analytics/overview"),this.apiCall("/wp-json/geo-elementor/v1/analytics/countries"),this.apiCall("/wp-json/geo-elementor/v1/analytics/rules"),this.apiCall("/wp-json/geo-elementor/v1/analytics/trends")]);this.data={overview:e,countries:a,rules:s,trends:t}}catch(e){this.renderError()}})}apiCall(e){return d(this,null,function*(){let a=yield fetch(e);if(!a.ok)throw new Error(`HTTP ${a.status}`);return a.json()})}renderLoading(){let e=document.getElementById("geo-el-admin-app");e&&(e.innerHTML=`
